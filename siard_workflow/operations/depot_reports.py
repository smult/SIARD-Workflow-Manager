...
_TOOL_DESCRIPTIONS = {
    ...
    "standardize_ext": "Standardiserer filendelser og filnavn (recordN) i LOB-mapper",
    "siardmapper":     "Beriker metadata med tabell-/kolonnebeskrivelser",
    "lobfolder_fix":   "Korrigerer lobFolder- og file=-referanser for DBPTK-kompatibilitet",
